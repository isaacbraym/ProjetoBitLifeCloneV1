...
public class GameTester {
    private static GerenciadorEventos gerenciadorEventos;

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        ProvedorEntrada provedorEntrada = new ProvedorEntrada(scanner);
        Personagem personagem = new Personagem("Braym");
        personagem.adicionarObservador(new ConsoleObservador());

        // Agora usamos GerenciadorEventos em vez de EventManager
        // e precisamos passar um ProvedorEntrada
        gerenciadorEventos = new GerenciadorEventos("Eventos", provedorEntrada);
    ...
    private static void exibirMenu() {
        System.out.println("\n==== BitLife Clone ====");
        System.out.println("1. Mostrar status do personagem");PersonagemTest
